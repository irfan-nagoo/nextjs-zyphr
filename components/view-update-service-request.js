...
import { getServiceRequestById, saveServiceRequest } from "../lib/service-request";
                    ...
                    <form action="#" className="p-4 md:p-5" onSubmit={onSubmit}>
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            <div className="col-span-2">
                                ...
                                <input type="text" name="title" id="title" defaultValue={serReqDetail && serReqDetail.title} onChange={() =>{}} className="valid:border-green-500 focus:outline-none bg-gray-50 border text-gray-900 text-sm rounded-lg  block w-full p-2.5" required />
                            </div>
                            <div className="col-span-2 sm:col-span-1">
                                <label htmlFor="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category:</label>
                                <select name="category" id="category" value={serReqDetail && serReqDetail.category} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg valid:border-green-500 focus:outline-none block w-full p-2.5" onChange={handleOnChange} required>
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <select name="type" id="type" value={serReqDetail && serReqDetail.type} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg valid:border-green-500 focus:outline-none block w-full p-2.5" required>
                            ...
                            <div className="col-span-2">
                                ...
                                <textarea name="description" id="description" defaultValue={serReqDetail && serReqDetail.description} onChange={() =>{}} rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 valid:border-green-500 focus:outline-none" placeholder="Description here" required></textarea>
                            </div>
                            <div className="col-span-2">
                                <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900">Requester Name:</label>
                                <input type="text" name="userName" id="userName" defaultValue={serReqDetail && serReqDetail.userName} onChange={() =>{}} className="valid:border-green-500 focus:outline-none bg-gray-50 border text-gray-900 text-sm rounded-lg  block w-full p-2.5" placeholder="Requester Name here" required />
                            </div>
                        </div>
